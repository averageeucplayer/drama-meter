...
export interface LoadResult {
    ...
    appName: string;
    esthers: Esther[];
    estherNameToIcon: Record<string, string>;
    arkPassiveIdToSpec: Record<number, string>;
    arkPassives: ArkPassiveDict;
    bossHpMap: Record<string, number>;
    encounterMap: Record<string, Record<string,string[]>>;
    difficultyMap: string[];
    raidGates: Record<string, string>;
    guardianRaidBosses: string[];
    classesMap: Record<number, string>;
    classNameToClassId: Record<string, number>;
    classes: string[];
...
export interface AppContext extends LoadResult {}

export type ArkPassive = [string, string, number, number, number, number, number];
export type ArkPassiveDict = Record<number, ArkPassive>
